...
public class AgreementCreationResponse {
  ...
  public AgreementCreationResponse id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @ApiModelProperty(value = "The unique identifier of the agreement")
  public String getId() {
    return id;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AgreementCreationResponse agreementCreationResponse = (AgreementCreationResponse) o;
    return Objects.equals(this.id, agreementCreationResponse.id);
  }
