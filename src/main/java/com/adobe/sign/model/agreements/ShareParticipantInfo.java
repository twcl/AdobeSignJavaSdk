...
public class ShareParticipantInfo {
   ...
   * @return company
  **/
  @ApiModelProperty(value = "Company of the sharee participant, if available.")
   ...
   * @return email
  **/
  @ApiModelProperty(value = "Email of the sharee participant of the agreement.")
   ...
   * @return name
  **/
  @ApiModelProperty(value = "Name of the sharee participant, if available.")
  ...
  **/
  @ApiModelProperty(value = "The unique identifier of the sharee participant of the agreement.")
  ...
  **/
  @ApiModelProperty(value = "The unique identifier of the participant who shared the agreement.")
