...
public class WebhookStateInfo {
  ...
  public WebhookStateInfo state(StateEnum state) {
    this.state = state;
    return this;
  }
   ...
   * @return state
  **/
  @ApiModelProperty(value = "The state to which the webhook should be changed to")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    WebhookStateInfo webhookStateInfo = (WebhookStateInfo) o;
    return Objects.equals(this.state, webhookStateInfo.state);
  }
